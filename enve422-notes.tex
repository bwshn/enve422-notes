...
i\begin{itemize}
    ...
    \item Pathogenic Microorganisms\\
    Pathogens are always in the sludge. 
    \item Toxicity\\
...
% Circle: 
\node[circle, draw, text width=1cm, align=center] (empty) {};
...
\node[right= 0.5 cm of drying] (dryingLabel) {Since 35\% is not enough for many applications, 95\% can be achieved};
...
\begin{enumerate}
    ...
    \item Wetting a particle with water and then "scrubbed" (only wet or dry system except 6)
\end{enumerate}
...
\date{\begin{flushright}June 1, 2023\end{flushright}}
\end{document}