...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\textwidth]{SludgeQuantities.png} % maybe recreate this in tikz
...
It uses earthworms\ they ingest the sludge with the food provided (if the sludge has enough organic content), emerge as odorless worm feces. No \textit{Salmonella} species are found.\\
...
\ce{Pb} $>$ \ce{Cd} (\ce{Pb} can be exposed more), \ce{Cd} is highly and more toxic, \ce{Cd} poisoning -> ouch-ouch disease.\\
