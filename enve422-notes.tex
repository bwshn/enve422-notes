...
\date{\begin{flushright}March 17 (before class), 2023\end{flushright}}
...
\begin{enumerate}
    ...
    \textcolor{red}{Shows similar behavior with gravity, physical separation might be hard.}\\ % check the answer
    Sludge is suspension, solid and liquid and more than one solid (volatile and fixed components exist).\\
    1/S = total wi/si % formulate this part
    \item Sludge density\\
    ...
    \begin{itemize}
        ...
        ZSV is in inverse relationship with concentration and hyperbolic.\\ % write this part with formulation
        Why is there such a relationship?\\
        \textcolor{red}{Higher concentration compresses in more time, the particles creates interference.}\\ % check the answer
        ...
        SVI = V\textsubscript{30} * 1000 / MLSS\\ % can be formulated
        ...
        \begin{enumerate}
            ...
            \item water\\
            Extracellular polymers (EPS) hold individual micoroorgganisms $\rightarrow$ flocs causes separation an settling.\\
